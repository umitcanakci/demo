...
<div class="rts-breadcrumb-area breadcrumb-bg bg_image" style=" background-image: url({{url('/assets/images/breadcrumb/kurumsal.webp')}}); ">
    <div class="container">
        <div class="col-12 text-center">
            <h4 class="title sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800" style="color: white;">Blog #eduglobal</h4>
        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12" data-sal-delay="150"  data-sal-duration="800">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogView', ['slug' => $blog->slug]) }}">
                                    ...
                                    <div class="date">
                                        <span class="title">{{ $blog->created_at->format('d/m/Y') }}</span>
                                    </div>
                                </div>
                                <div class="blog-body">
                                    <a href="{{ route('blogView', ['slug' => $blog->slug]) }}">
                                        ...
                                        <p class="pt-3">{!! Illuminate\Support\Str::limit($blog->excerpt,100) !!}</p>
                                    </a>
