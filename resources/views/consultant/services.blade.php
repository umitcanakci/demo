...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Servislerim</h4> <a href="{{ route('consultant.service.add') }}" class="btn btn-sm btn-success"> Hizmet Ekle </a> 
        </div>
        <div class="card-body">
                            ...
                            <tr id="service-{{$service->id}}">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <button type="button" id="deleteService" data-id="{{ $service->id }}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
...
<script>
    $('.btn-danger').on('click', function(){
        ...
        $.ajax({
            type:'POST',
            url: "{{ route('consultant.service.delete')}}",
            data: {
                id:id
            },
